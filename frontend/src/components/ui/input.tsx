  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-ring focus-visible:shadow-[0_0_0_3px_rgba(59,130,246,0.15)]",
        "aria-invalid:shadow-[0_0_0_3px_rgba(220,38,38,0.15)] aria-invalid:border-destructive",
        className,
      )}
      {...props}
    />
